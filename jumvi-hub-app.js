...
export function initHub3D(opts) {
  ...
  // end-cap UVs rotate and mirror the image depending on which cap you look
  // at, which is what made the first version read upside-down. A circle's UVs
  // are planar and face +Z, so the text is upright by construction.
