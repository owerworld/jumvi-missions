...
for(const k of ['R5_realDeviceCriticalJourney','v2EnvironmentCredentialRoutePermissions','liveCoexistenceStagingExactArtifact'])assert.equal(g[k],'VERIFIED',`Open release gate: ${k}`);
